	...
	<!-- 	<div class="request-quote-section">
			<button><a href="https://www.conceptopensource.com/request-quote">
				
			</a>Request Quote
			</button>
		</div>

		<div class="we-hiring-section">
			<button><a href="https://www.conceptopensource.com/request-quote">
		...
		<div id="header">
			...
			<div class="nav-btn">
				<span class="nav-button">
					<span class="mobile-menu-icon_open">
						<i class="fa fa-bars"></i>
					</span>
					<span class="mobile-menu-icon_close">
			...
			<div class="top-head">
				<div class="container">
					<div class="inner-header">
						...
						<div class="email-sec">
								<a id="coopsomail" class="email_section" href="mailto:sales#conceptopensource.com">
								
								sales@conceptopensource.com
							</a>
						</div>
						<div class="contact-sec">
							<a class="phone-call"><i class="fa fa-phone"></i>
								+918780882871(INDIA)
							</a>
							...
							<ul class="nav-list">
								...
								<li class="dropdown">
									...
									<a>Developement</a>
										...
										<li><a href="#">Cms Developement</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-content">
										...
										<li><a href="#">Hire Magneto Developer</a></li>
								...
								<li class="nav-li"><a href="testimonials.php">Testimonials</a></li>
								<li class="nav-li"><a href="">Portfolio</a></li>
								<li  class="nav-li"><a href="">Company</a></li>
								<li  class="nav-li"><a href="FAQ.php">FAQ</a></li>
								<li  class="nav-li"><a href="contact-us.php">Contact us</a></li>
